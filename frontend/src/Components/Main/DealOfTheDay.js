                    ...
                    <div key={deal._id} className="relative group">
                        ...
                        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-64 sm:w-64 md:w-64 bg-white p-4 rounded-lg shadow-lg transition-transform duration-300 group-hover:translate-y-0 translate-y-1/2">
                            ...
                            <div className="flex justify-between mt-4">
                                <button onClick={() => handleAddToCart(deal._id)} className="bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 transition-transform transform hover:scale-105">
                                    Add to Cart
                                </button>
