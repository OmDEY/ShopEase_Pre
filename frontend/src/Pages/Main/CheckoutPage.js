...
import { FiCreditCard, FiDollarSign, FiTruck, FiLock, FiCheck, FiEdit2 } from 'react-icons/fi';
...
const CheckoutPage = () => {
    ...
    const PaymentMethodCard = ({ icon, title, description, value, selected }) => (
        <div 
            className={`border rounded-xl p-4 cursor-pointer transition-all ${selected ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 hover:border-indigo-300'}`}
            onClick={() => handlePaymentChange(value)}
        >
            <div className="flex items-center">
                <div className={`p-2 rounded-lg mr-4 ${selected ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-600'}`}>
                    {icon}
                </div>
                <div>
                ...
                <div className="flex justify-center mb-12">
                    <div className="flex items-center">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="mt-2 text-sm font-medium text-indigo-600">Shipping</span>
                        </div>
                        <div className="w-24 h-1 bg-indigo-200 mx-2"></div>
                        <div className="flex flex-col items-center">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${selectedPayment ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
                                2
                            </div>
                            <span className={`mt-2 text-sm font-medium ${selectedPayment ? 'text-indigo-600' : 'text-gray-500'}`}>Payment</span>
                        </div>
                                ...
                                {selectedPayment === 'upi' && (
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-4 gap-2">
                                            ...
                                            <img src="https://img.icons8.com/color/48/000000/phonepe.png" alt="PhonePe" className="h-12" />
                                            <img src="https://img.icons8.com/color/48/000000/paytm.png" alt="Paytm" className="h-12" />
                                            <img src="https://img.icons8.com/color/48/000000/bhim.png" alt="BHIM" className="h-12" />
                                        </div>
                                    </motion.div>
                                )}
                        ...
                        >
                            ...
                            <div className="p-6">
                                {isLoading ? (
                                    ...
                                    <div className="space-y-4">
                                        {cartItems.map((item) => (
                                            <div key={item.product?._id} className="flex items-start border-b border-gray-100 pb-4">
                                                <img 
                                                ...
                                                <div className="flex-grow">
                                                    ...
                                                    <p className="text-sm text-gray-500">{item.product?.description?.substring(0, 50)}...</p>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <button
                                    className={`w-full py-3 px-4 mt-6 rounded-lg shadow-sm text-lg font-medium text-white ${!selectedPayment ? 'bg-gray-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700'} transition-colors`}
