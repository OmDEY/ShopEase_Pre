...
const relatedProducts = [
  ...
  },
  {
    ...
    price: "₹89.00",
    image:
      "https://images.unsplash.com/photo-1555680202-c86f0e12f086?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
    rating: 4.8,
    reviews: 256,
  },
  {
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        Placed on {new Date(order.createdAt).toLocaleString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}
                      </p>
                    </div>
                  </div>
                          ...
                          <div className="flex flex-col items-end">
                            ...
                            {order.orderStatus === "Delivered" && (
                              <div className="flex flex-col gap-2 w-full md:w-64">
                                {!itemRatings[`${order.id}-${idx}`] ||
                                itemRatings[`${order.id}-${idx}`] === 0 ? (
                                  <>
                                    <div className="flex justify-center gap-1">
                                      {[1, 2, 3, 4, 5].map((star) => (
                                        <button
                                          key={star}
                                          onClick={() =>
                                            handleRateItem(order.id, idx, star)
                                          }
